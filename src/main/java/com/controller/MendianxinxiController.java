...
public class MendianxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		mendianxinxi.setClicknum(mendianxinxi.getClicknum()+1);
		mendianxinxi.setClicktime(new Date());
		mendianxinxiService.updateById(mendianxinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,MendianxinxiEntity mendianxinxi, HttpServletRequest request,String pre){
        EntityWrapper<MendianxinxiEntity> ew = new EntityWrapper<MendianxinxiEntity>();
