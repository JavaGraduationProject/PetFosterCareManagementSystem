...
public class ChongwuyiliaoController {
    ...
    public R save(@RequestBody ChongwuyiliaoEntity chongwuyiliao, HttpServletRequest request){
    	chongwuyiliao.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ChongwuyiliaoEntity> wrapper = new EntityWrapper<ChongwuyiliaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = chongwuyiliaoService.selectCount(wrapper);
