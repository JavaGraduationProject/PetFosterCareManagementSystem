		...
		<div id="app">
			...
			<div class="news-container">
				...
				<div class="btn-container" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 30px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"4px","borderWidth":"3px","borderStyle":"solid","justifyContent":"flex-end","height":"50px"}'>
					...
					<button :style='{"padding":"0 15px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(142, 182, 160, 1)","color":"#fff","borderRadius":"0","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}' onclick="back()" type="button" class="layui-btn layui-btn-lg btn-theme">
