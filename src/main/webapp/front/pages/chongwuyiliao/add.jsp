		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">适合宠物：</label>
						<div class="layui-input-block">
							<input v-model="detail.shihechongwu" type="text" :readonly="ro.shihechongwu" name="shihechongwu" id="shihechongwu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="xiangmujianjie" id="xiangmujianjie">请输入项目简介</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var xiangmujianjie = tinymce.get('#xiangmujianjie').getContent()
					data.xiangmujianjie = xiangmujianjie;
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('chongwuyiliao/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('chongwuyiliao' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
