...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">服务选择管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>服务选择列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">服务选择列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="fuwuleixingSearch" class="form-control form-control-sm" placeholder="请输入服务类型" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xuanzebianhao')">选择编号<i id="xuanzebianhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('xuanzeriqi')">选择日期<i id="xuanzeriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#fuwuleixingSearch').val() != null && $('#fuwuleixingSearch').val() != ''){
				searchForm.fuwuleixing ="%" +  $('#fuwuleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("fuwuxuanze/page","GET",{
				...
				fuwuleixing : searchForm.fuwuleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var xuanzebianhaoCell  = document.createElement('td');

						 xuanzebianhaoCell.innerHTML = item.xuanzebianhao;

			row.appendChild(xuanzebianhaoCell);
			...
			var xuanzeriqiCell  = document.createElement('td');

						  xuanzeriqiCell.innerHTML = item.xuanzeriqi;


			row.appendChild(xuanzeriqiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fuwuxuanze/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"fuwuxuanze");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"fuwuxuanze");
