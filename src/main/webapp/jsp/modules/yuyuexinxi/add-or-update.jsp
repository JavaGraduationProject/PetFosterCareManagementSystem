					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>预约信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑预约信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">预约信息信息</h3>
									...
									<div class="form-group col-md-6">
										...
										<input name="yonghuxingming" id="yonghuxingming" name="yonghuxingming" class="form-control" placeholder="用户姓名">
											...
											<div class="form-group  col-md-12" >
												<label>预约内容</label>
												<div><div class="upload"><input id="yuyueneirongupload" name="file" type="file">选择文件</div>
												<script id="yuyueneirongEditor" type="text/plain"></script>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yuyuexinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyuexinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyuexinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('yuyueneirongEditor').hasContents()){
				$('#yuyueneirong-input').attr('value',UE.getEditor('yuyueneirongEditor').getContent());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuexinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuyueneirong != null && res.data.yuyueneirong != ''){
                        ...
                        var yuyueneirongMes = '' + res.data.yuyueneirong;
                        var yuyueneirongUeditor = UE.getEditor('yuyueneirongEditor');
                        yuyueneirongUeditor.ready(function() {
                            yuyueneirongUeditor.setContent(yuyueneirongMes);
                        });
