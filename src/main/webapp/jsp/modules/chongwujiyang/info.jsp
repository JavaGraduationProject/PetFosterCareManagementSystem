						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jiyangdanhao" name="jiyangdanhao" class="form-control" v-model="ruleForm.jiyangdanhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>门店名称</label>
									...
									<input id="shifoujiyang" name="shifoujiyang" class="form-control" v-model="ruleForm.shifoujiyang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>宠物名称</label>
									...
									<input id="shifoujueyu" name="shifoujueyu" class="form-control" v-model="ruleForm.shifoujueyu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>年龄</label>
									...
									<input id="jiyangriqi" name="jiyangriqi" class="form-control" v-model="ruleForm.jiyangriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>寄养原因</label>

									<input id="jiyangyuanyin" name="jiyangyuanyin" class="form-control" v-model="ruleForm.jiyangyuanyin" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户账号</label>
